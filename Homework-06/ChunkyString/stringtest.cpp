...
/**
 * \brief Checks the equality operator for ChunkyString by making two ChunkyStrings
 *        with identical characters and checking if they are equal
 */
...
/**
 * \brief Checks the inequality operator for ChunkyString by making two ChunkyStrings
 *        with different characters and checking if they are not equal
 */
bool notEqualsTest()
{
    // Set up the TestingLogger object
...
/**
 * \brief Checks the less than operator for ChunkyString by making two ChunkyStrings
 *        with different characters and checking the appropriate one is less than
 */
bool lessThanTest()
{
    // Set up the TestingLogger object
...
/**
 * \brief Checks the utilization method for ChunkyString by making a ChunkyString
 *        with and checking if the utilization is above the required threshold
 */
bool utiTest()
{
    // Set up the TestingLogger object
 ...
 *        and calling the method to add character and then checking if the size changed
 */
bool pushBackTest()
{
    // Set up the TestingLogger object
 ...
 *        calling insert and cheking if the size changed and the iterator now points
 ...
 *        calling the method and checking if the size changed and the iterator now
 *        points to the character after the erased one.
 */
bool eraseTest()
{
    // Set up the TestingLogger object
...
/**
 * \brief Checks the plus equals operator for ChunkyString by making a ChunkyStrings
 *        calling the operator and making sure the size changed
 */
bool plusEqualsTest()
{
    // Set up the TestingLogger object
 ...
 *        calling the operator to a ostringstream and making sure the right thing is printed
 */
bool displayTest()
{
    // Set up the TestingLogger object
 ...
 *        calling the method and making sure iterator points to the beginning of the ChunkyString
 */
bool beginTest()
{
    // Set up the TestingLogger object
