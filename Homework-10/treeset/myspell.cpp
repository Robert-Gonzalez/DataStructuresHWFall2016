 ...
 * \file myspell.cpp
 *
 * \author CS 70 Provided Code with additions by hawk and reindeer
 *
...
void spellcheck(const string& dictfile, bool debug)
{
    ...
    // Load up our dictionary of correct words
    spellchecker.populateDict(dictfile, debug);

    spellchecker.spellCheck(cin);
}
